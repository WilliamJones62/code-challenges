...
require 'medium/remove_duplicates_2'
...
describe RemoveDuplicates2 do
  let(:rd) { described_class.new }

  describe 'remove_duplicates_2' do
    it "returns 5 for [1,1,1,2,2,3]" do
        expect(rd.remove_duplicates_2([1,1,1,2,2,3])).to eq(5)
    end
    it "returns 7 for [0,0,1,1,1,1,2,3,3]" do
        expect(rd.remove_duplicates_2([0,0,1,1,1,1,2,3,3])).to eq(7)
    end
  end
end