...
require 'medium/insert_interval'
...
# [start, end] that represents the start and end of another 
# interval.
...
describe InsertInterval do
    let(:ii) { described_class.new }
  
    describe 'insert_interval' do
      it "returns [[1,5],[6,9]] for [[1,3],[6,9]], [2,5]" do
          expect(ii.insert_interval([[1,3],[6,9]], [2,5])).to eq([[1,5],[6,9]])
      end
      it "returns [[1,2],[3,10],[12,16]] for [[1,2],[3,5],[6,7],[8,10],[12,16]], [4,8]" do
        expect(ii.insert_interval([[1,2],[3,5],[6,7],[8,10],[12,16]], [4,8])).to eq([[1,2],[3,10],[12,16]])
      end
    end
  end