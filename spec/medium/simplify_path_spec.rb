...
# should be treated as a valid directory or file name. For example, 
...
describe SimplifyPath do
  ...
  describe 'simplify_path' do
    it "returns '/home' for '/home/'" do
        expect(sp.simplify_path('/home/')).to eq('/home')
    end
    it "returns '/home/foo' for '/home//foo/'" do
        expect(sp.simplify_path('/home//foo/')).to eq('/home/foo')
    end
    it "returns '/home/user/Pictures' for '/home/user/Documents/../Pictures'" do
        expect(sp.simplify_path('/home/user/Documents/../Pictures')).to eq('/home/user/Pictures')
    end
    it "returns '/' for '/../'" do
        expect(sp.simplify_path('/../')).to eq('/')
    end
    it "returns '/.../b/d' for '/.../a/../b/c/../d/./'" do
        expect(sp.simplify_path('/.../a/../b/c/../d/./')).to eq('/.../b/d')
    end
  end
end